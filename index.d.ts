// Type definitions for jsforce v1.7.1
...
declare module 'jsforce' {
  ...
  interface Promise {
    all(promises: any): PromiseLike<Array<any>>;// {Promise.<Array.<*>>}
    defer(): PromiseLike<any>;// {Deferred}
    reject(reason: any): PromiseLike<any>;// {Promise}
    resolve(result: any): PromiseLike<any>;// {Promise}
    catch(onRejected: any): PromiseLike<{}>;// {Promise.<S>}
    fail(onRejected: any): PromiseLike<{}>;// {Promise.<S>}
    then(onFulfilled?: any): PromiseLike<{}>;// {Promise.<(S1)>}
    then(onFulfilled?: any, onRejected?: any): PromiseLike<{}>;// {Promise.<(S1|S2)>}
    thenCall(callback?: Function): PromiseLike<any>;// {Promise}
  }
